    ...
    <form method="POST" action="/admin/event_update/{{ $event_details->id }}">
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" placeholder="Event Name" id="event_name" class="form-control" name="event_name"
                    required autofocus value="{{ $event_details->event_name }}">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" placeholder="Max Seats" id="no_of_seats" class="form-control" name="no_of_seats"
                    required value="{{ $event_details->no_of_seats }}">
